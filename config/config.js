...
// subprocesses - the number of child processes to use for various tasks.
//   Can be set to `0` instead of `{...}` to stop using subprocesses, if you're running out of RAM.
// MOD AÑIL: en 0 para un servidor de amigos chico — evita que cada worker (network,
// simulator, validator, etc.) cargue su propia copia de los datos en memoria, que era
// lo que nos hacía pasar los 512MB del plan gratis de Render.
