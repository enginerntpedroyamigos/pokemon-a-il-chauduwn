...
export const Formats: import('../sim/dex-formats').FormatList = [
	...
	{
		name: "[Gen 9] Añil OU",
		desc: `Formato basado en Pok&eacute;mon A&ntilde;il (fangame de EricLostie): stats rebalanceados, ` +
			`movimientos y habilidades propias del hack, y las Eeveelutions exclusivas Royaleon y Cefireon.`,
		mod: 'anil',
		ruleset: ['Standard', 'Dynamax Clause'],
	},
	{
		name: "[Gen 9] Añil Custom Game",
		desc: `Pok&eacute;mon A&ntilde;il sin restricciones de tier, para probar cualquier equipo.`,
		mod: 'anil',
		searchShow: false,
		debug: true,
		battle: { trunc: Math.trunc },
	...
	},
	{
		...
		banlist: [
			...
			'Shaymin-Sky', 'Slaking', 'Smeargle', 'Sneasler', 'Solgaleo', 'Spectrier', 'Urshifu-Base', 'Urshifu-Rapid-Strike', 'Volcarona', 'Weavile', 'Zamazenta',
