export const Abilities: import('../../../sim/dex-abilities').ModdedAbilityDataTable = {
	...
	inflamable: {
		...
		flags: {},
		name: "Inflamable",
		shortDesc: "Aumenta un 50% el daño de los movimientos de tipo Fuego.",
		rating: 3,
		num: 317,
	},
	...
	albino: {
		...
		flags: {},
		name: "Albino",
		shortDesc: "Aumenta un 50% el daño de los movimientos de tipo Hielo.",
		rating: 3,
		num: 318,
	},
	...
	floracin: {
		...
		flags: {},
		name: "Floración",
		shortDesc: "Aumenta un 50% el daño de los movimientos de tipo Planta.",
		rating: 3,
		num: 320,
	},
	...
	realeza: {
		...
		flags: {},
		name: "Realeza",
		shortDesc: "Recibe un bonus de daño del 50% al atacar, sin importar el tipo del movimiento.",
		rating: 4.5,
		num: 321,
	},
	...
	silvano: {
		...
		flags: {},
		name: "Silvano",
		shortDesc: "Con Campo de Hierba activo, aumenta un 30% el daño de cualquier movimiento.",
		rating: 3,
		num: 324,
	},
	...
	camorrista: {
		...
		onBasePower(basePower, attacker, defender, move) {
			const kickMoves = [
				'axekick', 'blazekick', 'doublekick', 'highjumpkick', 'jumpkick', 'lowkick',
				'megakick', 'rollingkick', 'thunderouskick', 'triplekick', 'tropkick',
			];
	...
	tintineo: {
		onStart(pokemon) {
			...
			for (const ally of pokemon.side.pokemon) {
				if (ally.status) {
					this.add('-message', `${ally.name} se curó gracias al Tintineo.`);
					ally.cureStatus();
				}
			}
		},
		...
		flags: {},
		name: "Tintineo",
		shortDesc: "Al salir, cura el estado de todo el equipo. Los movs. de sonido pasan a Psíquico y ganan 20% de potencia.",
		rating: 3,
		num: 326,
	},
	...
	razrobusta: {
		...
		flags: {},
		name: "Raíz Robusta",
		shortDesc: "Los movimientos y efectos que drenan PS recuperan un 30% más.",
		rating: 2,
		num: 327,
	},
