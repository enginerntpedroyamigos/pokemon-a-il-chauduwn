export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	// === Fakemon de Pokémon Añil (fangame de EricLostie) ===
	// Eeveelutions propias del hack, agregadas acá (como los CAP) para que el cliente
	// las reconozca como especies reales (búsqueda, sprites). Solo tienen sentido de
	// evolución/uso real dentro del mod "anil" (ver data/mods/anil/pokedex.ts).
	royaleon: {
		num: -5015,
		name: "Royaleon",
		types: ["Normal"],
