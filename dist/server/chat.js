...
const Chat = new class {
  ...
  getDataPokemonHTML(species, options = {}) {
  ...
  getDataAbilityHTML(ability, options = {}) {
    const { dex = Dex } = options;
