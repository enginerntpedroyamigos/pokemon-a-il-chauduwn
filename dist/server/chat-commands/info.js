      ...
      switch (newTarget.searchType) {
        ...
        case "pokemon":
          ...
          buffer += `${prefix}${Chat.getDataPokemonHTML(
            pokemon,
            { dex, tier: displayedTier, language: this.language }
          )}
`;
          if (showDetails) {
        ...
        case "item":
          ...
          buffer += `${prefix}${Chat.getDataItemHTML(
            item,
            { dex, language: this.language, hideShortDescription: showDetails }
          )}
`;
          if (showDetails) {
...
`;
      ...
      if (showDetails) {
        if (description) {
          buffer += `${prefix}${import_lib.Utils.escapeHTML(description)}
`;
        }
