...
${e.stack}`), `Socket process ${process.pid}`);
    ...
    try {
      ...
      const clientServer = new import_static_server.StaticServer("./server/static-client");
      const proxyToOfficialClient = (req, res) => {
