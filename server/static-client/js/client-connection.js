...
function PSConnection(){var _this=this;this.socket=null;this.connected=false;this.lastMessageTimeBeforeReconnect=0;this.queue=[];this.reconnectDelay=1000;this.reconnectCap=60000;this.shouldReconnect=true;this.reconnectTimer=null;this.worker=null;this.lastReceiveTime=Date.now();this.nextRetryTime=0;
...
setInterval(function(){return _this.keepAlive();},KEEPALIVE_INTERVAL);
...
if(Date.now()-this.lastReceiveTime>3*KEEPALIVE_INTERVAL){var _this$socket;
...
_this3.handleConnect();
};

socket.onmessage=function(ev){
var data=''+ev.data;
_this3.lastReceiveTime=Date.now();
...
markDisconnected=function markDisconnected(){
...
this.queue=[];for(var _i2=0;_i2<
queue.length;_i2++){var msg=queue[_i2];this.send(msg);}
...
disconnect=function disconnect(){var _this$socket2,_this$worker;
this.shouldReconnect=false;
(_this$socket2=this.socket)==null||_this$socket2.close();
...
return;
}else if(location.protocol+"//"+location.host===PSStorage.origin){var _Config;
