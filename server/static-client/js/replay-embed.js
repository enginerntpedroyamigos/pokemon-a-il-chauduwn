...
linkStyle('https://localhost:8081/style/font-awesome.css?');
linkStyle('https://localhost:8081/style/battle.css?a7');
linkStyle('https://localhost:8081/style/replay.css?a7');
linkStyle('https://localhost:8081/style/utilichart.css?a7');

requireScript('https://localhost:8081/js/lib/ps-polyfill.js');
requireScript('https://localhost:8081/config/config.js?a7');
requireScript('https://localhost:8081/js/lib/jquery-1.11.0.min.js');
requireScript('https://localhost:8081/js/lib/html-sanitizer-minified.js');
requireScript('https://localhost:8081/js/battle-sound.js');
requireScript('https://localhost:8081/js/battledata.js?a7');
requireScript('https://localhost:8081/data/pokedex-mini.js?a7');
requireScript('https://localhost:8081/data/pokedex-mini-bw.js?a7');
requireScript('https://localhost:8081/data/graphics.js?a7');
requireScript('https://localhost:8081/data/pokedex.js?a7');
requireScript('https://localhost:8081/data/moves.js?a7');
requireScript('https://localhost:8081/data/abilities.js?a7');
requireScript('https://localhost:8081/data/items.js?a7');
requireScript('https://localhost:8081/data/teambuilder-tables.js?a7');
requireScript('https://localhost:8081/js/battle-tooltips.js?a7');
requireScript('https://localhost:8081/js/battle.js?a7');
