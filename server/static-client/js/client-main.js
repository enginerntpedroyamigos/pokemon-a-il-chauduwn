...
protocol=location.protocol==='https:'?'https':'http';this.
groups={
'#':{
name:"Room Owner (#)",
type:'leadership',
...
for(var _roomid4 in PS.rooms){var _PS$rooms$_roomid;
var battle=(_PS$rooms$_roomid=PS.rooms[_roomid4])==null?void 0:_PS$rooms$_roomid.battle;
...
rooms.length;_i21++){var _roomid5=rooms[_i21];
PS.leave(_roomid5);
}
...
var isInit=false;for(var _i29=0,_msg$split2=
msg.split('\n');_i29<_msg$split2.length;_i29++){var _room3;var line=_msg$split2[_i29];
...
addRoomType=function addRoomType(){for(var _len4=arguments.length,types=new Array(_len4),_key5=0;_key5<_len4;_key5++){types[_key5]=arguments[_key5];}for(var _i31=0;_i31<
types.length;_i31++){var RoomType=types[_i31];
this.roomTypes[RoomType.id]=RoomType;for(var _i33=0,_RoomType$routes2=
RoomType.routes;_i33<_RoomType$routes2.length;_i33++){var route=_RoomType$routes2[_i33];
...
if(options.backlog){for(var _i35=0,_options$backlog2=
options.backlog;_i35<_options$backlog2.length;_i35++){var args=_options$backlog2[_i35];
room.receiveLine(args);
}
}
...
var autojoins=[];
var autojoinCount=0;
var rooms=[].concat(this.miniRoomList,this.leftRoomList,this.rightRoomList);for(var _i37=0;_i37<
rooms.length;_i37++){var _roomid7=rooms[_i37];
