...
var automaticLayout=document.documentElement.clientHeight>=950?'Comfortable':'Compact';
...
preact.h("li",null,preact.h("button",{onClick:this.setTab,value:"import","class":"button button-last"+(this.mode==='import'?' cur':'')},"Import/Export"
...
preact.h("summary",{"class":"button button-first"},"Options"),
...
)," Zoom out forms"):preact.h("label",null,"Layout: ",preact.h("select",{
name:"layout","class":"select",onChange:this.setLayout,
value:layout===null?'automatic':layout?'comfortable':'compact'},

preact.h("option",{value:"automatic"},"Automatic (",automaticLayout,")"),
preact.h("option",{value:"compact"},"Compact"),
preact.h("option",{value:"comfortable"},"Comfortable")
)),
mobileOptions&&preact.h("label",{"class":"checkbox"},preact.h("input",{
name:"zoomoutsearch",type:"checkbox",
checked:zoomOutSearch,onChange:this.setZoomOutSearch}
)," Zoom out search results")
)
)
)
),
...
return preact.h("div",{"class":narrow?'tiny-layout':'',style:"font-size:10pt",role:"dialog","aria-label":"Stats"},
...
Object.entries(BattleNatures).map(function(_ref10){var natureName=_ref10[0],curNature=_ref10[1];return(
